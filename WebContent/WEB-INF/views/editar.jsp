            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  ...
                  <button type="button" onclick="window.location.href = '${pageContext.request.contextPath}/guardarE'" class="btn btn-primary" style="width:140px">Guardar sucursal</button>
                </div>
              </div>
            </div>
